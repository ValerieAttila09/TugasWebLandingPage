    ...
    <>
      <div className="relative h-[680px] w-full overflow-hidden">
        ...
        <div className="absolute bg-transparent z-5 inset-0 w-full h-full flex flex-col items-center justify-start container-wrapper gap-4">
          <h1 className="max-w-3xl text-center text-2xl sm:text-3xl md:text-4xl text-white font-medium flex flex-col justify-center items-center">
            <span className="">Trusted by developers, ready for agents. Build and scale applications faster with Xenora.</span>
          </h1>
        ...
        <div className="absolute z-2 -bottom-5 sm:-bottom-1/7 md:-bottom-1/5 inset-x-10 sm:inset-x-1/7 md:inset-x-1/4 w-auto h-auto border border-neutral-700 bg-neutral-900/30 backdrop-blur-sm rounded-xl p-3">
