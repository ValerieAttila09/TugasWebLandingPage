      ...
      <nav className='w-full px-4 sm:px-8 flex items-center justify-between py-2'>
            ...
            {landingPageNavMenu.map((data) => {
              ...
              return (
                <Link
                  key={data.label}
                  href={data.href}
                  className='flex items-center gap-1 justify-center font-normal min-w-12 max-w-20 relative hover:text-neutral-300 transition-colors'
                >
        ...
        <div className='flex items-center gap-2 sm:gap-4'>
          ...
          <div className='hidden sm:flex gap-2'>
            ...
            <Link href={'/sign-up'} className='font-regular text-xs sm:text-sm px-2 sm:px-4 rounded-sm border border-neutral-800 bg-neutral-950 py-2 hover:bg-neutral-900 hover:border-neutral-700 hover:shadow hover:shadow-violet-950 transition-all'>
