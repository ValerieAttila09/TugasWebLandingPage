      ...
      <div>
        {currentPath === "/" ? (
          <Link href={"/"} className="flex items-center cursor-pointer">
            <div className='size-10 mx-4 my-2 flex items-center justify-center rounded-lg bg-linear-to-br from-purple-800 via-black to-violet-700 border-2 border-violet-400'>
            ...
            <span className="font-semibold bg-clip-text text-transparent bg-linear-to-r from-violet-500 to-white text-2xl">NEXORA</span>
          </Link>
        ) : (
          <NavbarButton />
        )}
